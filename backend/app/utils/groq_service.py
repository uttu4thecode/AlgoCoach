...
if not GROQ_API_KEY:
    raise RuntimeError(
        "[AlgoCoach] GROQ_API_KEY is not set in your .env file. "
        "Get a free key from https://console.groq.com and add it as:\n"
...
def get_hint(
    ...
    try:
        ...
        return f"AI hint service is temporarily unavailable. Please try again shortly. (Error: {type(e).__name__})"